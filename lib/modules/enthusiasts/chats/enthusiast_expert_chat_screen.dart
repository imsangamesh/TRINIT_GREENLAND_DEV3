...
class EnthusiastExpertChatScreen extends StatefulWidget {
  const EnthusiastExpertChatScreen({Key? key}) : super(key: key);

  @override
  State<EnthusiastExpertChatScreen> createState() =>
      _EnthusiastExpertChatScreenState();
}

class _EnthusiastExpertChatScreenState
    extends State<EnthusiastExpertChatScreen> {
  ...
  void sendMessage() async {
    ...
    try {
      fire
          .collection('chats')
          .doc('enthusiasts_expert_chats')
          .collection('enthusiasts_expert_chats')
          .doc(
