...
import '../../../model/farmer_expert_model.dart';
...
class LocationServices {
  ...
  /// ------------------------------------------------------------------ `get Address`
  static Future<FarmerExpertAppointmentModel> getAddress(
    ...
    final place = FarmerExpertAppointmentModel(
      id: '',
      ...
      isVerified: 'false',
      farmSoilType: FarmSoilType.notEntered,
    );
